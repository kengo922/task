...
ActiveRecord::Schema.define(version: 2020_08_04_140517) do
  ...
  create_table "teachers", options: "ENGINE=InnoDB DEFAULT CHARSET=utf8", force: :cascade do |t|
    ...
    t.datetime "created_at", null: false
    t.datetime "updated_at", null: false
    t.index ["day_id"], name: "index_teachers_on_day_id"
    t.index ["department_id"], name: "index_teachers_on_department_id"
    t.index ["limit_id"], name: "index_teachers_on_limit_id"
    t.index ["subject_id"], name: "index_teachers_on_subject_id"
  end

  add_foreign_key "teachers", "days"
  add_foreign_key "teachers", "departments"
  add_foreign_key "teachers", "limits"
